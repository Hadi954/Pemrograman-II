<%-- 
    Document   : newjsp
    Created on : May 15, 2026, 6:11:37 AM
    Author     : Hadi
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="com.unpam.model.Barang"%>
...
<%
    ...
    Barang itemSelected = new Barang();
    ...
    if (tombol != null) {
        ...
        if (hargaStr != null && !hargaStr.isEmpty()) {
            barang.setHarga(Integer.parseInt(hargaStr));
        }

        if (stokStr != null && !stokStr.isEmpty()) {
            barang.setStok(Integer.parseInt(stokStr));
        }
        ...
        if (tombol.equals("Simpan")) {
            ...
            // Mengambil data berdasarkan kode yang dipilih dari radio button
            String kodeCari = request.getParameter("kodeBarangPilih");
            if (kodeCari != null) {
                itemSelected.getByKode(kodeCari);
            }
        } else if (tombol.equals("Cari")) {
            // Mengambil data berdasarkan input kode barang
            itemSelected.getByKode(barang.getKodeBarang());
        }
    }
    ...
    <div class="container-form">
        <form method="post">
            <div class="form-group">
                ...
                <div class="input-row">
                    <input type="text" name="kodeBarang" value="<%= (itemSelected.getKodeBarang() != null) ? itemSelected.getKodeBarang() : "" %>">
            ...
            <div class="form-group">
                <label>Harga :</label>
                <input type="text" name="harga" value="<%= (itemSelected.getHarga() != 0) ? itemSelected.getHarga() : "" %>">
            </div>

            <div class="form-group">
                <label>Stok :</label>
                <input type="text" name="stok" value="<%= (itemSelected.getStok() != 0) ? itemSelected.getStok() : "" %>">
            </div>
            ...
            <div style="margin-top: 30px;">
                <table style="width: 100%; margin-top: 0;">
                    ...
                    <%
                        List<Barang> list = new Barang().tampil();
                        for (Barang b : list) {
                    %>
                    <tr>
                        <td class="radio-cell">
                            <input type="radio" name="kodeBarangPilih" value="<%= b.getKodeBarang() %>">
                        </td>
